...
const ForLynkers = () => {
  return (
    <section id="for-lynkers" className="py-20 sm:py-32 overflow-hidden relative">
      {/* Background Gradient */}
        ...
        <div className="max-w-4xl mx-auto text-center mb-12">
          ...
          >
            ...
            <p className="text-xl text-gray-500 text-foreground/70 mb-8">
              Turn your empathy into earnings. Become a verified Lynker and help people through real conversations.
            </p>
          </motion.div>
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-sm text-foreground/70 mb-1 text-gray-500">{benefit.title}</div>
