                ...
                <div className="flex-1 pr-12 text-right">
                  <div className="bg-white p-6 rounded-2xl shadow-lg border border-pink-100">
                    ...
                    <p className="text-gray-600">
                      Started with 50 carefully vetted Lynkers and 200 beta
              ...
              <div className="relative flex items-center">
                <div className="flex-1 pr-12 text-right">
                  <div className="bg-white p-6 rounded-2xl shadow-lg border border-pink-100">
                    ...
                    <p className="text-gray-600">
                      Expanded to 500+ Lynkers across multiple categories. First
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                came with unique challenges. We had to balance accessibility
                with safety, scale with quality, and technology with human
                connection.
              </p>
