...
export default function TeamSection() {
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      name: "Pavan Kalyan",
      role: "Founder & CEO",
      bio: "Tech entrepreneur with experience building scalable platforms. Expert in creating secure, user-friendly experiences.",
      image: "/team/hermione-granger.png",
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              a common goal: making the world a more connected place.
            </p>
          </div>
        </ScrollReveal>
